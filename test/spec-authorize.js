describe('authorize', function() {
	...
	beforeEach(module('mr.authorize', function ($provide, authorizeProvider, $stateProvider) {
		...
		$stateProvider
			.state('home', {})
			.state('home.sub', {})
			.state('home.protected', { auth: true })

			.state('protected1', { auth: true })
			.state('protected1.sub', {})
			.state('protected1.override', { auth: { override: true } })
			.state('protected2', { auth: 'p1' })
			.state('protected2.sub', {})
			.state('protected3', { auth: ['p1'] })
			.state('protected3.sub', {})
			.state('protected4', { auth: { policies: ['p1', 'p2'] }});
	}));
